...
A CLI tool to batch convert plain text (`.txt`) files to Markdown (`.md`). It understands the output format of [codebase-convert](https://github.com) and formats code blocks with proper syntax highlighting based on file extensions.
